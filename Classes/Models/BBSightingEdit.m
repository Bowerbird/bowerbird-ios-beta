...
-(void)setMediaResourceIds:(NSMutableArray *)media {
    _mediaResourceIds = media;
}

-(void)addMediaResourceId:(NSString*)mediaResourceId {
    [_mediaResourceIds addObject:mediaResourceId];
}

-(void)removeMediaResourceId:(NSString*)mediaResourceId {
    [_mediaResourceIds removeObject:mediaResourceId];
}
