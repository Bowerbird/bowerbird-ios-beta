...
- (void)reloadTextFields
{
	...
	for (id textField in self.textFields)
	{
	    if ([textField isKindOfClass:[UITextField class]]) {
            //((UITextField *) textField).delegate = self.delegate;
	        ((UITextField *) textField).inputAccessoryView = self;
        }
	    else if ([textField isKindOfClass:[UITextView class]]) {
	        ((UITextView *) textField).inputAccessoryView = self;
            //((UITextView *) textField).delegate = self.delegate;
        }
        else if ([textField isKindOfClass:[UIDatePicker class]]) {
	        //((UIDatePicker *) textField).inputAccessoryView = self;
        }
	}
}
