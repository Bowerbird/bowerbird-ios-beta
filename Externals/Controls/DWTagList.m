...
#define LABEL_MARGIN 10.0f//5.0f
#define BOTTOM_MARGIN 10.0f// 5.0f
#define FONT_SIZE 16.0f //13.0f
#define HORIZONTAL_PADDING 14.0f//7.0f
#define VERTICAL_PADDING 6.0f//3.0f
...
- (void)display
{
    ...
    for (NSString *text in textArray) {
        ...
        // HC added trimmedText to remove whitespace from start and end of string. Handy for when string source is from a tokenized array created from a comma separated string.
        NSString* trimmedText = [text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]];
        
        CGSize textSize = [trimmedText sizeWithFont:[UIFont systemFontOfSize:FONT_SIZE] constrainedToSize:CGSizeMake(self.frame.size.width, 1500) lineBreakMode:UILineBreakModeWordWrap];
